...
const ComboEdit = ({ route }) => {
    ...
    const edit = async () => {
        let data = JSON.stringify({
          ...
          let config = {
            ...
            url: 'http://localhost:8000/combo/' + datas._id,
            headers: { 
    ...
    return (
        <>
            <Typography.Title level={4}>Sửa Combo Bắp & Nước</Typography.Title>
            <Form
                labelCol={{
                    span: 4,
                }}
            ...
            >
                ...
                <Form.Item label="Chi Tiết Combo">
                    <Input type="text"
                        name="details"
                        value={datas?.details}
                        onChange={handleChange} />
